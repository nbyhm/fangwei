...
import com.dowell.util.convert.ExportConvert;
import com.dowell.util.poi.excel.ExportConfig;
import com.dowell.util.poi.excel.ExportHandler;
import com.dowell.util.poi.ExportItem;
...
public class ExcelUtils {
	...
	private void requiredbuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用com.dowell.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void requiredexportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用com.dowell.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
